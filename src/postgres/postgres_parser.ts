    ...
    try {
      return apply(current, node => {
        ...
        if (r.peekIf(TokenType.LeftParen)) {
          apply(this.append(node, new Element("ExplainOptionList", {})), node => {
            this.append(node, r.consume())
            do {
              if (r.peekIf(Keyword.ANALYZE)) {
                apply(this.append(node, new Element("AnalyzeOption", {})), node => {
                  this.append(node, r.consume())
                ...
                apply(this.append(node, new Element("VerboseOption", {})), node => {
                  this.append(node, r.consume())
                  if (r.peekIf({ type: [Keyword.TRUE, Keyword.FALSE] })) {
                    this.booleanLiteral(node, r)
                  }
                ...
                apply(this.append(node, new Element("CostsOption", {})), node => {
                  this.append(node, r.consume())
                  if (r.peekIf({ type: [Keyword.TRUE, Keyword.FALSE] })) {
                    this.booleanLiteral(node, r)
                  }
                ...
                apply(this.append(node, new Element("SettingsOption", {})), node => {
                  this.append(node, r.consume())
                  if (r.peekIf({ type: [Keyword.TRUE, Keyword.FALSE] })) {
                    this.booleanLiteral(node, r)
                  }
                ...
                apply(this.append(node, new Element("BuffersOption", {})), node => {
                  this.append(node, r.consume())
                  if (r.peekIf({ type: [Keyword.TRUE, Keyword.FALSE] })) {
                    this.booleanLiteral(node, r)
                  }
                ...
                apply(this.append(node, new Element("WalOption", {})), node => {
                  this.append(node, r.consume())
                  if (r.peekIf({ type: [Keyword.TRUE, Keyword.FALSE] })) {
                    this.booleanLiteral(node, r)
                  }
                ...
                apply(this.append(node, new Element("TimingOption", {})), node => {
                  this.append(node, r.consume())
                  if (r.peekIf({ type: [Keyword.TRUE, Keyword.FALSE] })) {
                    this.booleanLiteral(node, r)
                  }
                ...
                apply(this.append(node, new Element("SummaryOption", {})), node => {
                  this.append(node, r.consume())
                  if (r.peekIf({ type: [Keyword.TRUE, Keyword.FALSE] })) {
                    this.booleanLiteral(node, r)
                  }
                ...
                apply(this.append(node, new Element("FormatOption", {})), node => {
                  this.append(node, r.consume())
