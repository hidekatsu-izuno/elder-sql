...
export default [
	...
	new Token(TokenType.Identifier, "date_of_action", {
		location: new SourceLocation(66, 2, 24),
	}),
	new Token(TokenType.Reserved, "DATE", {
	...
	new Token(TokenType.Comma, ",", { location: new SourceLocation(85, 2, 43) }),
	...
	new Token(TokenType.Reserved, "VARCHAR2", {
		keyword: Keyword.VARCHAR2,
		preskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.Numeric, "20", {
	...
	new Token(TokenType.Numeric, "30", {
	...
	new Token(TokenType.Identifier, "REPLACE", {
	...
	new Token(TokenType.Identifier, "PACKAGE", {
	...
	new Token(TokenType.Reserved, "TYPE", {
	...
	new Token(TokenType.Identifier, "RECORD", {
	...
	new Token(TokenType.Reserved, "NUMBER", {
	...
	new Token(TokenType.Comma, ",", { location: new SourceLocation(298, 7, 43) }),
	...
	new Token(TokenType.Reserved, "CURSOR", {
		keyword: Keyword.CURSOR,
		preskips: [
			new Token(TokenType.WhiteSpace, "   ", {
	...
	new Token(TokenType.Reserved, "EXCEPTION", {
	...
	new Token(TokenType.Reserved, "FUNCTION", {
	...
	new Token(TokenType.Reserved, "PROCEDURE", {
	...
	new Token(TokenType.SemiColon, ";", {
		postskips: [
			...
			new Token(TokenType.LineComment, "-- overloaded subprogram", {
	...
	new Token(TokenType.SemiColon, ";", {
		postskips: [
			...
			new Token(TokenType.LineComment, "-- visible only in this package", {
	...
	new Token(TokenType.Reserved, "BY", {
		keyword: Keyword.BY,
		preskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.Reserved, "DESC", {
	...
	new Token(TokenType.Reserved, "BEGIN", {
	...
	new Token(TokenType.Dot, ".", { location: new SourceLocation(1540, 33, 27) }),
	...
	new Token(TokenType.Reserved, "SYSDATE", {
		keyword: Keyword.SYSDATE,
		preskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.Dot, ".", { location: new SourceLocation(1810, 38, 18) }),
	new Token(TokenType.Identifier, "PUT_LINE", {
		location: new SourceLocation(1811, 38, 19),
	}),
	new Token(TokenType.LeftParen, "(", {
		location: new SourceLocation(1819, 38, 27),
	}),
	new Token(TokenType.String, "'The number of employees hired is '", {
		postskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.Identifier, "MAX", {
		keyword: Keyword.MAX,
		preskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.Reserved, "IF", {
		keyword: Keyword.IF,
		preskips: [
			new Token(TokenType.WhiteSpace, "      ", {
	...
	new Token(TokenType.Identifier, "RAISE", {
		keyword: Keyword.RAISE,
		preskips: [
			new Token(TokenType.WhiteSpace, "         ", {
	...
	new Token(TokenType.Dot, ".", { location: new SourceLocation(3080, 72, 19) }),
	new Token(TokenType.Identifier, "PUT_LINE", {
	...
	new Token(TokenType.String, "'The salary is out of the specified range.'", {
	...
	new Token(TokenType.Identifier, "OPEN", {
	...
	new Token(TokenType.Reserved, "FETCH", {
		keyword: Keyword.FETCH,
		preskips: [
			new Token(TokenType.WhiteSpace, "         ", {
	...
	new Token(TokenType.Identifier, "CLOSE", {
	...
	new Token(TokenType.Reserved, "BEGIN", {
		...
		postskips: [
			...
			new Token(TokenType.LineComment, "-- initialization part starts here", {
	...
	new Token(TokenType.Reserved, "USER", {
	...
	new Token(TokenType.Reserved, "DECLARE", {
		keyword: Keyword.DECLARE,
		preskips: [
			new Token(TokenType.LineComment, "-- calling the package procedures", {
	...
	new Token(TokenType.Dot, ".", { location: new SourceLocation(3673, 93, 26) }),
	new Token(TokenType.Identifier, "hire_employee", {
	...
	new Token(TokenType.String, "'Belden'", {
	...
	new Token(TokenType.Numeric, "2500", {
		preskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.Numeric, "101", {
		preskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.Numeric, "110", {
		preskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.Dot, ".", { location: new SourceLocation(3801, 95, 14) }),
	new Token(TokenType.Identifier, "PUT_LINE", {
	...
	new Token(TokenType.String, "'The new employee id is '", {
		postskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.Dot, ".", { location: new SourceLocation(3874, 96, 12) }),
	new Token(TokenType.Identifier, "raise_salary", {
	...
	new Token(TokenType.Dot, ".", { location: new SourceLocation(3919, 97, 14) }),
	new Token(TokenType.Identifier, "PUT_LINE", {
	...
	new Token(TokenType.String, "'The 10th highest salary is '", {
	...
	new Token(TokenType.Dot, ".", { location: new SourceLocation(3983, 98, 22) }),
	new Token(TokenType.Identifier, "nth_highest_salary", {
	...
	new Token(TokenType.Dot, ".", { location: new SourceLocation(4006, 98, 45) }),
	new Token(TokenType.Identifier, "sal", {
	...
	new Token(TokenType.Dot, ".", { location: new SourceLocation(4068, 99, 25) }),
	new Token(TokenType.Identifier, "nth_highest_salary", {
	...
	new Token(TokenType.Dot, ".", { location: new SourceLocation(4091, 99, 48) }),
	new Token(TokenType.Identifier, "emp_id", {
