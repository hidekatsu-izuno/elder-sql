...
export default [
	...
	new Token(SqlTokenType.Identifier, "code", {
		preskips: [
			new Token(SqlTokenType.WhiteSpace, "    ", {
	...
	new Token(SqlTokenType.Identifier, "char", {
		keyword: SqlKeyword.CHAR,
		preskips: [
			new Token(SqlTokenType.WhiteSpace, "        ", {
	...
	new Token(SqlTokenType.Numeric, "5", {
	...
	new Token(SqlTokenType.Identifier, "firstkey", {
		preskips: [
			new Token(SqlTokenType.WhiteSpace, " ", {
	...
	new Token(SqlTokenType.Identifier, "varchar", {
		keyword: SqlKeyword.VARCHAR,
		preskips: [
			new Token(SqlTokenType.WhiteSpace, "       ", {
	...
	new Token(SqlTokenType.Numeric, "40", {
	...
	new Token(SqlTokenType.Identifier, "hour", {
	...
	new Token(SqlTokenType.Identifier, "minute", {
	...
	new Token(SqlTokenType.Identifier, "production", {
		preskips: [
			new Token(SqlTokenType.WhiteSpace, " ", {
	...
	new Token(SqlTokenType.Identifier, "code_title", {
		preskips: [
			new Token(SqlTokenType.WhiteSpace, " ", {
	...
	new Token(SqlTokenType.Identifier, "GENERATED", {
		keyword: SqlKeyword.GENERATED,
		preskips: [
			new Token(SqlTokenType.WhiteSpace, " ", {
	...
	new Token(SqlTokenType.Identifier, "IDENTITY", {
		keyword: SqlKeyword.IDENTITY,
		preskips: [
			new Token(SqlTokenType.WhiteSpace, " ", {
	...
	new Token(SqlTokenType.Identifier, "con1", {
		preskips: [
			new Token(SqlTokenType.WhiteSpace, " ", {
	...
	new Token(SqlTokenType.String, "'Luso Films'", {
		preskips: [
			new Token(SqlTokenType.WhiteSpace, " ", {
	...
	new Token(SqlTokenType.String, "'distributors_serial'", {
	...
	new Token(SqlTokenType.Identifier, "modtime", {
		preskips: [
			new Token(SqlTokenType.WhiteSpace, "    ", {
	...
	new Token(SqlTokenType.Identifier, "timestamp", {
		keyword: SqlKeyword.TIMESTAMP,
		preskips: [
			new Token(SqlTokenType.WhiteSpace, "   ", {
	...
	new Token(SqlTokenType.Identifier, "no_null", {
		preskips: [
			new Token(SqlTokenType.WhiteSpace, " ", {
	...
	new Token(SqlTokenType.Identifier, "fillfactor", {
		keyword: SqlKeyword.FILLFACTOR,
		location: new SourceLocation(1877, 82, 24),
	}),
	new Token(SqlTokenType.Operator, "=", {
		location: new SourceLocation(1887, 82, 34),
	}),
	new Token(SqlTokenType.Numeric, "70", {
	...
	new Token(SqlTokenType.Identifier, "array_int", {
		preskips: [
			new Token(SqlTokenType.WhiteSpace, " ", {
