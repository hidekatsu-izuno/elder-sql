...
export default [
	...
	new Token(TokenType.Comma, ",", { location: new SourceLocation(27, 1, 27) }),
	new Token(TokenType.Identifier, "integer", {
		keyword: Keyword.INTEGER,
		preskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.Identifier, "RETURNS", {
		preskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.String, "'select $1 + $2;'", {
		preskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.Identifier, "IMMUTABLE", {
	...
	new Token(TokenType.Identifier, "INPUT", {
		preskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.Comma, ",", { location: new SourceLocation(172, 7, 30) }),
	...
	new Token(TokenType.Identifier, "increment", {
	...
	new Token(TokenType.Identifier, "plpgsql", {
		preskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.Identifier, "dup", {
		preskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.Identifier, "out", {
		keyword: Keyword.OUT,
		preskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.Identifier, "check_password", {
		preskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.Identifier, "uname", {
	...
	new Token(TokenType.Identifier, "pass", {
		preskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.Identifier, "SECURITY", {
		keyword: Keyword.SECURITY,
		preskips: [
			new Token(TokenType.WhiteSpace, "    ", {
	...
	new Token(TokenType.Identifier, "DEFINER", {
		keyword: Keyword.DEFINER,
		preskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.Identifier, "search_path", {
		preskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.Identifier, "admin", {
	...
	new Token(TokenType.Identifier, "pg_temp", {
		preskips: [
			new Token(TokenType.WhiteSpace, " ", {
