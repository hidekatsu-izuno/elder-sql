...
export default [
	...
	new Token(SqlTokenType.Identifier, "generate_series", {
		keyword: SqlKeyword.GENERATE_SERIES,
		preskips: [
			new Token(SqlTokenType.WhiteSpace, " ", {
