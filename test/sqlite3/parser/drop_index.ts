...
export default new Node("Script").apply(node => {
  node.append(new Node("DropIndexStatement").apply(node => {
    node.append(new Token(TokenType.Identifier, "DROP", { keyword: Keyword.DROP, location: new SourceLocation(0, 1, 0)}))
    node.append(new Token(TokenType.Reserved, "INDEX", { keyword: Keyword.INDEX, preskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(4, 1, 4)})], location: new SourceLocation(5, 1, 5)}))
    node.append(new Node("ObjectName").apply(node => {
      node.data = {"value":"i_sample"}
      node.append(new Token(TokenType.Identifier, "i_sample", { preskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(10, 1, 10)})], location: new SourceLocation(11, 1, 11)}))
    }))
  }))
  ...
  node.append(new Node("DropIndexStatement").apply(node => {
    ...
    node.append(new Token(TokenType.Reserved, "INDEX", { keyword: Keyword.INDEX, preskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(25, 2, 5)})], location: new SourceLocation(26, 2, 6)}))
    ...
    node.append(new Node("ObjectName").apply(node => {
      node.data = {"value":"i_sample"}
      node.append(new Token(TokenType.Identifier, "i_sample", { location: new SourceLocation(37, 2, 17)}))
    }))
  }))
  ...
  node.append(new Node("DropIndexStatement").apply(node => {
    ...
    node.append(new Token(TokenType.Reserved, "INDEX", { keyword: Keyword.INDEX, preskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(51, 3, 5)})], location: new SourceLocation(52, 3, 6)}))
    ...
    node.append(new Node("ObjectName").apply(node => {
      node.data = {"value":"i_sample"}
      node.append(new Token(TokenType.Identifier, "i_sample", { location: new SourceLocation(73, 3, 27)}))
    }))
  }))
