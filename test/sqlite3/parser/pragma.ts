...
export default new Node("Script")
  ...
  .append(new Node("PragmaStatement")
    ...
    .append(new Node("PragmaValue", "NONE")
  ...
  .append(new Node("PragmaStatement")
    ...
    .append(new Node("PragmaValue", "true")
  ...
  .append(new Node("PragmaStatement")
    ...
    .append(new Token(TokenType.LeftParen, "(", { location: new SourceLocation(246, 9, 23) }))
    .append(new Node("PragmaValue", "test.pk_test")
      .append(new Token(TokenType.String, "'test.pk_test'", { location: new SourceLocation(247, 9, 24) }))
    )
    .append(new Token(TokenType.RightParen, ")", { location: new SourceLocation(261, 9, 38) }))
