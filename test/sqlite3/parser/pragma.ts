...
export default new Node("Script", node => {
  ...
  node.append(new Node("PragmaStatement", node => {
    ...
    node.append(new Node("PragmaValue", node => {
  ...
  node.append(new Node("PragmaStatement", node => {
    ...
    node.append(new Node("PragmaValue", node => {
      node.append(new Node("PragmaLiteral", node => {
  ...
  node.append(new Node("PragmaStatement", node => {
    ...
    node.append(new Node("ArgumentList", node => {
      ...
      node.append(new Node("Argument", node => {
        node.append(new Node("StringLiteral", node => {
