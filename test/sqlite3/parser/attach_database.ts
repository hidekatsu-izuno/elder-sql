...
export default new Element("node", { type: "Script" }, [
	new Element("node", { type: "AttachDatabaseStatement" }, [
		new Element("token", { type: "Identifier", value: "ATTACH" }, [
			new Text("ATTACH"),
		]),
	...
	new Element("node", { type: "AttachDatabaseStatement" }, [
		...
		new Element("node", { type: "Database" }, [
			new Element("node", { type: "Expression" }, [
				new Element(
					"node",
					{ type: "StringLiteral", value: "new_database.db" },
					[
						new Element("token", { type: "String" }, [
							new Element("trivia", { type: "WhiteSpace" }, [new Text(" ")]),
					...
					new Element("node", { type: "FunctionArgumentList" }, [
						new Element("node", { type: "Argument" }, [
							new Element("node", { type: "Expression" }, [
								new Element(
									"node",
									{ type: "StringLiteral", value: "new_database" },
									[
										new Element("token", { type: "String" }, [
											new Text("'new_database'"),
										]),
									],
								),
							]),
					...
					new Element("node", { type: "Expression" }, [
						new Element("node", { type: "ConcatenateOperation" }, [
							new Element("node", { type: "ConcatenateOperation" }, [
								new Element(
									"node",
									{ type: "StringLiteral", value: "database_" },
									[
										new Element("token", { type: "String" }, [
											new Text("'database_'"),
											new Element("trivia", { type: "WhiteSpace" }, [
								...
								new Element("node", { type: "FunctionExpression" }, [
									new Element("node", { type: "ObjectName" }, [
										new Element(
											"token",
											{ type: "Identifier", value: "STRFTIME" },
											[
												new Element("trivia", { type: "WhiteSpace" }, [
													new Text(" "),
												]),
									...
									new Element("node", { type: "FunctionArgumentList" }, [
										new Element("node", { type: "Argument" }, [
											new Element("node", { type: "Expression" }, [
												new Element(
													"node",
													{ type: "StringLiteral", value: "%Y%m%d" },
													[
														new Element("token", { type: "String" }, [
															new Text("'%Y%m%d'"),
														]),
