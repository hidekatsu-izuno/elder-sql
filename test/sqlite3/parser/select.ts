...
export const expected = new Node("root")
  .append(new Node("select statement")
    .append(new Node("select clause")
      .append(new Token(Keyword.SELECT, "SELECT", { keyword: Keyword.SELECT, location: new SourceLocation(0, 1, 0) }))
      .append(new Node("select column list")
        .append(new Node("select column")
          .append(new Node("subtract operation")
            .append(new Node("add operation")
              .append(new Node("numeric literal", "1")
              ...
              .append(new Node("numeric literal", "2")
            ...
            .append(new Node("numeric literal", "3")
        ...
        .append(new Node("select column")
          .append(new Node("unary minus operation")
            .append(new Token(TokenType.Operator, "-", { location: new SourceLocation(14, 1, 14) }))
            .append(new Node("divide operation")
              .append(new Node("multiply operation")
                .append(new Node("numeric literal", "1")
          ...
          .append(new Node("column alias", "c1")
        ...
        .append(new Node("select column")
          .append(new Node("unary plus operation")
          ...
          .append(new Token(Keyword.AS, "AS", { keyword: Keyword.AS, preskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(31, 1, 31) })], location: new SourceLocation(32, 1, 32) }))
          .append(new Node("column alias", "c2")
