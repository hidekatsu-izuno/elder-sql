...
export default new Element("node", { type: "Script" }, [
	...
	new Element("node", { type: "SelectStatement" }, [
		...
		new Element("node", { type: "OrderByClause" }, [
			new Element("token", { type: "Reserved", value: "ORDER" }, [
				new Text("ORDER"),
			]),
			new Element("token", { type: "Identifier", value: "BY" }, [
				new Element("trivia", { type: "WhiteSpace" }, [new Text(" ")]),
		...
		new Element("node", { type: "LimitClause" }, [
			new Element("token", { type: "Reserved", value: "LIMIT" }, [
				new Text("LIMIT"),
			]),
						...
						new Element("node", { type: "FunctionExpression" }, [
							new Element(
								...
								[
									new Element(
										"token",
										{ type: "Reserved", value: "CURRENT_TIME" },
										[
											new Element("trivia", { type: "WhiteSpace" }, [
												new Text(" "),
											]),
						...
						new Element("node", { type: "FunctionExpression" }, [
							new Element(
								...
								[
									new Element(
										"token",
										{ type: "Reserved", value: "CURRENT_DATE" },
										[
											new Element("trivia", { type: "WhiteSpace" }, [
												new Text(" "),
											]),
						...
						new Element("node", { type: "FunctionExpression" }, [
							new Element(
								...
								[
									new Element(
										"token",
										{ type: "Reserved", value: "CURRENT_TIMESTAMP" },
										[
											new Element("trivia", { type: "WhiteSpace" }, [
												new Text(" "),
											]),
