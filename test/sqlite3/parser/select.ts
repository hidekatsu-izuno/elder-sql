...
export default new Node("Script", node => {
  node.append(new Node("SelectStatement", node => {
    node.append(new Node("SelectClause", node => {
      node.append(new Token(TokenType.Reserved, "SELECT", { keyword: Keyword.SELECT, location: new SourceLocation(0, 1, 0)}))
      node.append(new Node("SelectColumnList", node => {
        node.append(new Node("SelectColumn", node => {
          node.append(new Node("SubtractOperation", node => {
        ...
        node.append(new Node("SelectColumn", node => {
          node.append(new Node("UnaryMinusOperation", node => {
            node.append(new Token(TokenType.Operator, "-", { location: new SourceLocation(14, 1, 14)}))
            node.append(new Node("DivideOperation", node => {
              node.append(new Node("MultiplyOperation", node => {
                node.append(new Node("NumericLiteral", node => {
                  node.data = {"value":"1"}
          ...
          node.append(new Node("ColumnAlias", node => {
            node.data = {"value":"c1"}
        ...
        node.append(new Node("SelectColumn", node => {
          node.append(new Node("UnaryPlusOperation", node => {
    ...
    node.append(new Token(TokenType.EoF, "", { eos: true, location: new SourceLocation(37, 1, 37)}))
  }))
})
