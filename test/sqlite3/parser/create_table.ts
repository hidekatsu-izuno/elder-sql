...
export default new Node("Script", node => {
  node.append(new Node("CreateTableStatement", node => {
    ...
    node.append(new Node("SchemaName", node => {
    ...
    node.append(new Node("TableColumn", node => {
      node.append(new Node("ColumnName", node => {
      ...
      node.append(new Node("ColumnType", node => {
        node.append(new Node("TypeName", node => {
      ...
      node.append(new Node("ColumnConstraint", node => {
  ...
  node.append(new Node("CreateTableStatement", node => {
    ...
    node.append(new Node("TableConstraint", node => {
      node.append(new Node("PrimaryKeyConstraint", node => {
        ...
        node.append(new Node("SortingColumnList", node => {
          ...
          node.append(new Node("SortingColumn", node => {
            node.append(new Node("ColumnName", node => {
              node.data = {"value":"text_column"}
  ...
  node.append(new Node("CreateTableStatement", node => {
    ...
    node.append(new Node("TableConstraint", node => {
      ...
      node.append(new Node("ConstraintName", node => {
      ...
      node.append(new Node("UniqueConstraint", node => {
        ...
        node.append(new Node("RollbackOption", node => {
    ...
    node.append(new Node("TableConstraint", node => {
      ...
      node.append(new Node("CheckConstraint", node => {
        ...
        node.append(new Node("AddOperation", node => {
          node.append(new Node("ColumnReference", node => {
            node.append(new Node("ColumnName", node => {
              node.data = {"value":"col_1"}
          ...
          node.append(new Node("GreaterThanOperation", node => {
            node.append(new Node("ColumnReference", node => {
              node.append(new Node("ColumnName", node => {
                node.data = {"value":"col_2"}
            ...
            node.append(new Node("NumericLiteral", node => {
              node.data = {"value":"0"}
    ...
    node.append(new Node("TableConstraint", node => {
      ...
      node.append(new Node("ForeignKeyConstraint", node => {
        ...
        node.append(new Node("ReferencesClause", node => {
          ...
          node.append(new Node("OnDeleteClause", node => {
          ...
          node.append(new Node("MatchSimpleOption", node => {
          ...
          node.append(new Node("NotDeferrableOption", node => {
