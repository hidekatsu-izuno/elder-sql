...
export const expected = new Node("Script")
  .append(new Node("CreateTableStatement")
    ...
    .append(new Node("ObjectName", "test")
      .append(new Token(TokenType.Identifier, "test", { keyword: Keyword.TEST, preskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(12, 1, 12) })], postskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(17, 1, 17) })], location: new SourceLocation(13, 1, 13) }))
    )
    ...
    .append(new Node("TableColumn")
      .append(new Node("ColumnName", "text")
        .append(new Token(TokenType.Identifier, "text", { keyword: Keyword.TEXT, preskips: [new Token(TokenType.WhiteSpace, "    ", { location: new SourceLocation(20, 2, 1) })], location: new SourceLocation(24, 2, 5) }))
      )
    ...
    .append(new Token(TokenType.Comma, ",", { postskips: [new Token(TokenType.LineBreak, "\n", { location: new SourceLocation(46, 2, 27) })], location: new SourceLocation(45, 2, 26) }))
    .append(new Node("TableColumn")
      .append(new Node("ColumnName", "age")
        .append(new Token(TokenType.Identifier, "age", { keyword: Keyword.AGE, preskips: [new Token(TokenType.WhiteSpace, "    ", { location: new SourceLocation(47, 3, 1) })], location: new SourceLocation(51, 3, 5) }))
      )
      .append(new Node("ColumnType")
        .append(new Node("TypeName", "INT")
