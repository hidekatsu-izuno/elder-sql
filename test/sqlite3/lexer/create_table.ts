...
export const expected = [
  ...
  new Token(TokenType.SemiColon, ";", { eos: true, postskips: [new Token(TokenType.BlockComment, "/* test table_2 */", { location: new SourceLocation(306, 10, 1)}), new Token(TokenType.LineBreak, "\n", { location: new SourceLocation(324, 10, 19)})], location: new SourceLocation(304, 9, 2)}),
  new Token(Keyword.CREATE, "CREATE", { keyword: Keyword.CREATE, location: new SourceLocation(325, 11, 1)}),
  ...
  new Token(TokenType.Identifier, "table_2", { preskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(342, 11, 18)})], postskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(350, 11, 26)})], location: new SourceLocation(343, 11, 19)}),
  new Token(TokenType.LeftParen, "(", { postskips: [new Token(TokenType.LineBreak, "\n", { location: new SourceLocation(352, 11, 28)})], location: new SourceLocation(351, 11, 27)}),
  new Token(TokenType.QuotedValue, "\"text_column\"", { preskips: [new Token(TokenType.WhiteSpace, "  ", { location: new SourceLocation(353, 12, 1)})], location: new SourceLocation(355, 12, 3)}),
  ...
  new Token(TokenType.Comma, ",", { postskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(383, 12, 31)}), new Token(TokenType.BlockComment, "/*text affinity*/", { location: new SourceLocation(384, 12, 32)}), new Token(TokenType.LineBreak, "\n", { location: new SourceLocation(401, 12, 49)})], location: new SourceLocation(382, 12, 30)}),
  new Token(TokenType.QuotedIdentifier, "[num_column]", { preskips: [new Token(TokenType.WhiteSpace, "  ", { location: new SourceLocation(402, 13, 1)})], location: new SourceLocation(404, 13, 3)}),
  ...
  new Token(TokenType.Comma, ",", { postskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(434, 13, 33)}), new Token(TokenType.BlockComment, "/*numeric affinity*/", { location: new SourceLocation(435, 13, 34)}), new Token(TokenType.LineBreak, "\n", { location: new SourceLocation(455, 13, 54)})], location: new SourceLocation(433, 13, 32)}),
  new Token(TokenType.QuotedIdentifier, "`int_column`", { preskips: [new Token(TokenType.WhiteSpace, "  ", { location: new SourceLocation(456, 14, 1)})], location: new SourceLocation(458, 14, 3)}),
  ...
  new Token(TokenType.Comma, ",", { postskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(479, 14, 24)}), new Token(TokenType.BlockComment, "/*integer affinity*/", { location: new SourceLocation(480, 14, 25)}), new Token(TokenType.LineBreak, "\n", { location: new SourceLocation(500, 14, 45)})], location: new SourceLocation(478, 14, 23)}),
  new Token(TokenType.QuotedValue, "\"real_column\"", { preskips: [new Token(TokenType.WhiteSpace, "  ", { location: new SourceLocation(501, 15, 1)})], location: new SourceLocation(503, 15, 3)}),
  ...
  new Token(TokenType.Comma, ",", { postskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(525, 15, 25)}), new Token(TokenType.BlockComment, "/*real affinity*/", { location: new SourceLocation(526, 15, 26)}), new Token(TokenType.LineBreak, "\n", { location: new SourceLocation(543, 15, 43)})], location: new SourceLocation(524, 15, 24)}),
  new Token(TokenType.QuotedIdentifier, "[blob_column]", { preskips: [new Token(TokenType.WhiteSpace, "  ", { location: new SourceLocation(544, 16, 1)})], location: new SourceLocation(546, 16, 3)}),
  ...
  new Token(TokenType.Comma, ",", { postskips: [new Token(TokenType.WhiteSpace, "   ", { location: new SourceLocation(565, 16, 22)}), new Token(TokenType.BlockComment, "/*no affinity*/", { location: new SourceLocation(568, 16, 25)}), new Token(TokenType.LineBreak, "\n", { location: new SourceLocation(583, 16, 40)})], location: new SourceLocation(564, 16, 21)}),
  new Token(TokenType.QuotedIdentifier, "`no_affinity_column`", { preskips: [new Token(TokenType.WhiteSpace, "  ", { location: new SourceLocation(584, 17, 1)})], location: new SourceLocation(586, 17, 3)}),
  new Token(TokenType.Comma, ",", { postskips: [new Token(TokenType.WhiteSpace, "  ", { location: new SourceLocation(607, 17, 24)}), new Token(TokenType.BlockComment, "/*no affinity*/", { location: new SourceLocation(609, 17, 26)}), new Token(TokenType.LineBreak, "\n", { location: new SourceLocation(624, 17, 41)})], location: new SourceLocation(606, 17, 23)}),
  new Token(Keyword.PRIMARY, "PRIMARY", { keyword: Keyword.PRIMARY, preskips: [new Token(TokenType.WhiteSpace, "  ", { location: new SourceLocation(625, 18, 1)})], location: new SourceLocation(627, 18, 3)}),
  new Token(TokenType.Identifier, "KEY", { keyword: Keyword.KEY, preskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(634, 18, 10)})], postskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(638, 18, 14)})], location: new SourceLocation(635, 18, 11)}),
  new Token(TokenType.LeftParen, "(", { location: new SourceLocation(639, 18, 15)}),
  ...
  new Token(TokenType.SemiColon, ";", { eos: true, postskips: [new Token(TokenType.BlockComment, "/* test table_3 */", { location: new SourceLocation(668, 20, 1)}), new Token(TokenType.LineBreak, "\n", { location: new SourceLocation(686, 20, 19)})], location: new SourceLocation(666, 19, 2)}),
  new Token(Keyword.CREATE, "CREATE", { keyword: Keyword.CREATE, location: new SourceLocation(687, 21, 1)}),
  ...
  new Token(TokenType.Identifier, "table_3", { preskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(709, 21, 23)})], postskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(717, 21, 31)})], location: new SourceLocation(710, 21, 24)}),
  new Token(TokenType.LeftParen, "(", { postskips: [new Token(TokenType.LineBreak, "\n", { location: new SourceLocation(719, 21, 33)})], location: new SourceLocation(718, 21, 32)}),
  new Token(TokenType.Identifier, "col_1", { preskips: [new Token(TokenType.WhiteSpace, "  ", { location: new SourceLocation(720, 22, 1)})], location: new SourceLocation(722, 22, 3)}),
  ...
  new Token(TokenType.Comma, ",", { postskips: [new Token(TokenType.LineBreak, "\n", { location: new SourceLocation(733, 22, 14)})], location: new SourceLocation(732, 22, 13)}),
  new Token(TokenType.Identifier, "col_2", { preskips: [new Token(TokenType.WhiteSpace, "  ", { location: new SourceLocation(734, 23, 1)})], location: new SourceLocation(736, 23, 3)}),
  ...
  new Token(TokenType.Comma, ",", { postskips: [new Token(TokenType.LineBreak, "\n", { location: new SourceLocation(750, 23, 17)})], location: new SourceLocation(749, 23, 16)}),
  new Token(Keyword.CONSTRAINT, "CONSTRAINT", { keyword: Keyword.CONSTRAINT, preskips: [new Token(TokenType.WhiteSpace, "  ", { location: new SourceLocation(751, 24, 1)})], location: new SourceLocation(753, 24, 3)}),
  ...
  new Token(Keyword.UNIQUE, "UNIQUE", { keyword: Keyword.UNIQUE, preskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(769, 24, 19)})], postskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(776, 24, 26)})], location: new SourceLocation(770, 24, 20)}),
  new Token(TokenType.LeftParen, "(", { location: new SourceLocation(777, 24, 27)}),
  ...
  new Token(TokenType.Identifier, "col_2", { preskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(785, 24, 35)})], postskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(791, 24, 41)})], location: new SourceLocation(786, 24, 36)}),
  new Token(TokenType.RightParen, ")", { location: new SourceLocation(792, 24, 42)}),
  ...
  new Token(TokenType.Comma, ",", { postskips: [new Token(TokenType.LineBreak, "\n", { location: new SourceLocation(815, 24, 65)})], location: new SourceLocation(814, 24, 64)}),
  new Token(Keyword.CONSTRAINT, "CONSTRAINT", { keyword: Keyword.CONSTRAINT, preskips: [new Token(TokenType.WhiteSpace, "  ", { location: new SourceLocation(816, 25, 1)})], location: new SourceLocation(818, 25, 3)}),
  ...
  new Token(Keyword.CHECK, "CHECK", { keyword: Keyword.CHECK, preskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(834, 25, 19)})], postskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(840, 25, 25)})], location: new SourceLocation(835, 25, 20)}),
  new Token(TokenType.LeftParen, "(", { location: new SourceLocation(841, 25, 26)}),
  new Token(TokenType.Identifier, "col_1", { preskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(842, 25, 27)})], postskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(848, 25, 33)})], location: new SourceLocation(843, 25, 28)}),
  new Token(TokenType.Operator, "+", { location: new SourceLocation(849, 25, 34)}),
  new Token(TokenType.Identifier, "col_2", { preskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(850, 25, 35)})], postskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(856, 25, 41)})], location: new SourceLocation(851, 25, 36)}),
  new Token(TokenType.Operator, ">", { location: new SourceLocation(857, 25, 42)}),
  new Token(TokenType.Numeric, "0", { preskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(858, 25, 43)})], postskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(860, 25, 45)})], location: new SourceLocation(859, 25, 44)}),
  new Token(TokenType.RightParen, ")", { location: new SourceLocation(861, 25, 46)}),
  new Token(TokenType.Comma, ",", { postskips: [new Token(TokenType.LineBreak, "\n", { location: new SourceLocation(863, 25, 48)})], location: new SourceLocation(862, 25, 47)}),
  new Token(Keyword.CONSTRAINT, "CONSTRAINT", { keyword: Keyword.CONSTRAINT, preskips: [new Token(TokenType.WhiteSpace, "  ", { location: new SourceLocation(864, 26, 1)})], location: new SourceLocation(866, 26, 3)}),
  ...
  new Token(TokenType.Identifier, "KEY", { keyword: Keyword.KEY, preskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(890, 26, 27)})], postskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(894, 26, 31)})], location: new SourceLocation(891, 26, 28)}),
  new Token(TokenType.LeftParen, "(", { location: new SourceLocation(895, 26, 32)}),
  ...
  new Token(TokenType.Identifier, "col_2", { preskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(903, 26, 40)})], postskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(909, 26, 46)})], location: new SourceLocation(904, 26, 41)}),
  new Token(TokenType.RightParen, ")", { postskips: [new Token(TokenType.LineBreak, "\n", { location: new SourceLocation(911, 26, 48)})], location: new SourceLocation(910, 26, 47)}),
  new Token(Keyword.REFERENCES, "REFERENCES", { keyword: Keyword.REFERENCES, preskips: [new Token(TokenType.WhiteSpace, "    ", { location: new SourceLocation(912, 27, 1)})], location: new SourceLocation(916, 27, 5)}),
  new Token(TokenType.Identifier, "table_1", { preskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(926, 27, 15)})], postskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(934, 27, 23)})], location: new SourceLocation(927, 27, 16)}),
  new Token(TokenType.LeftParen, "(", { location: new SourceLocation(935, 27, 24)}),
  ...
  new Token(TokenType.RightParen, ")", { postskips: [new Token(TokenType.LineBreak, "\n", { location: new SourceLocation(960, 27, 49)})], location: new SourceLocation(959, 27, 48)}),
  new Token(Keyword.ON, "ON", { keyword: Keyword.ON, preskips: [new Token(TokenType.WhiteSpace, "    ", { location: new SourceLocation(961, 28, 1)})], location: new SourceLocation(965, 28, 5)}),
  ...
  new Token(Keyword.NULL, "NULL", { keyword: Keyword.NULL, preskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(978, 28, 18)})], postskips: [new Token(TokenType.LineBreak, "\n", { location: new SourceLocation(983, 28, 23)})], location: new SourceLocation(979, 28, 19)}),
  new Token(TokenType.Identifier, "MATCH", { keyword: Keyword.MATCH, preskips: [new Token(TokenType.WhiteSpace, "    ", { location: new SourceLocation(984, 29, 1)})], location: new SourceLocation(988, 29, 5)}),
  new Token(TokenType.Identifier, "table_1", { preskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(993, 29, 10)})], postskips: [new Token(TokenType.LineBreak, "\n", { location: new SourceLocation(1001, 29, 18)})], location: new SourceLocation(994, 29, 11)}),
  new Token(Keyword.ON, "ON", { keyword: Keyword.ON, preskips: [new Token(TokenType.WhiteSpace, "    ", { location: new SourceLocation(1002, 30, 1)})], location: new SourceLocation(1006, 30, 5)}),
  ...
  new Token(TokenType.Identifier, "CASCADE", { keyword: Keyword.CASCADE, preskips: [new Token(TokenType.WhiteSpace, " ", { location: new SourceLocation(1015, 30, 14)})], postskips: [new Token(TokenType.LineBreak, "\n", { location: new SourceLocation(1023, 30, 22)})], location: new SourceLocation(1016, 30, 15)}),
  new Token(Keyword.NOT, "NOT", { keyword: Keyword.NOT, preskips: [new Token(TokenType.WhiteSpace, "    ", { location: new SourceLocation(1024, 31, 1)})], location: new SourceLocation(1028, 31, 5)}),
