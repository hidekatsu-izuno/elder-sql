...
export default [
	...
	new Token(TokenType.Identifier, "VIEW", {
	...
	new Token(TokenType.Identifier, "v_sample", {
		preskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.Dot, ".", { location: new SourceLocation(64, 2, 31) }),
	new Token(TokenType.Identifier, "v_sample", {
		postskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.Dot, ".", { location: new SourceLocation(112, 3, 22) }),
	new Token(TokenType.Identifier, "v_sample", {
	...
	new Token(TokenType.Dot, ".", { location: new SourceLocation(161, 4, 27) }),
	new Token(TokenType.Identifier, "v_sample", {
		postskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.Comma, ",", { location: new SourceLocation(173, 4, 39) }),
	...
	new Token(TokenType.Comma, ",", { location: new SourceLocation(176, 4, 42) }),
	...
	new Token(TokenType.Comma, ",", { location: new SourceLocation(192, 4, 58) }),
	...
	new Token(TokenType.Comma, ",", { location: new SourceLocation(195, 4, 61) }),
	...
	new Token(TokenType.Dot, ".", { location: new SourceLocation(240, 5, 41) }),
	new Token(TokenType.Identifier, "v_sample", {
