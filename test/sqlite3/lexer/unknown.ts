...
export default [
	...
	new Token(SqlTokenType.BindVariable, "@aaa", {
		preskips: [
			new Token(SqlTokenType.WhiteSpace, " ", {
	...
	new Token(SqlTokenType.Error, "@", {
		location: new SourceLocation(53, 6, 12),
	}),
	...
	new Token(SqlTokenType.Error, "#", {
		location: new SourceLocation(60, 6, 19),
	}),
	new Token(SqlTokenType.Error, "#", {
		location: new SourceLocation(61, 6, 20),
	}),
	new Token(SqlTokenType.Error, "#", {
		location: new SourceLocation(62, 6, 21),
	}),
	new Token(SqlTokenType.SemiColon, ";", {
		eos: true,
		postskips: [
