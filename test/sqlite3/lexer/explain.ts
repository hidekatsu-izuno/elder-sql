...
export default [
	new Token(TokenType.Identifier, "EXPLAIN", {
	...
	new Token(TokenType.Comma, ",", { location: new SourceLocation(16, 1, 16) }),
	...
	new Token(TokenType.Identifier, "QUERY", {
	...
	new Token(TokenType.Identifier, "PLAN", {
	...
	new Token(TokenType.Dot, ".", { location: new SourceLocation(68, 3, 29) }),
	new Token(TokenType.Operator, "*", {
		location: new SourceLocation(69, 3, 30),
	}),
	new Token(TokenType.Comma, ",", { location: new SourceLocation(70, 3, 31) }),
	new Token(TokenType.Identifier, "t2", {
		preskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.Dot, ".", { location: new SourceLocation(74, 3, 35) }),
	new Token(TokenType.Operator, "*", {
	...
	new Token(TokenType.Comma, ",", { location: new SourceLocation(84, 3, 45) }),
	new Token(TokenType.Identifier, "t2", {
		preskips: [
			new Token(TokenType.WhiteSpace, " ", {
	...
	new Token(TokenType.Dot, ".", { location: new SourceLocation(97, 3, 58) }),
	new Token(TokenType.Identifier, "a", {
	...
	new Token(TokenType.Dot, ".", { location: new SourceLocation(108, 3, 69) }),
	new Token(TokenType.Identifier, "b", {
