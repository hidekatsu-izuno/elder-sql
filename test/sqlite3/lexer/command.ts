...
export default [
	new Token(TokenType.Command, ".print", {
		preskips: [
			new Token(TokenType.BlockComment, "/*test\n.print test\n*/", {
	...
	new Token(TokenType.Reserved, "select", {
		keyword: Keyword.SELECT,
		preskips: [
			new Token(TokenType.BlockComment, "/*.print*/", {
	...
	new Token(TokenType.Delimiter, "GO", {
		eos: true,
		preskips: [
			new Token(TokenType.LineComment, "-- aaa", {
				location: new SourceLocation(120, 14, 1),
			}),
			new Token(TokenType.LineBreak, "\n", {
				location: new SourceLocation(126, 14, 7),
			}),
			new Token(TokenType.LineComment, "-- bbb", {
