...
export default [
	...
	new Token(SqlLexer.Reserved, "TRANSACTION", {
		keyword: SqlLexer.TRANSACTION,
		preskips: [
	...
	new Token(SqlLexer.Identifier, "IMMEDIATE", {
		keyword: SqlLexer.IMMEDIATE,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "EXCLUSIVE", {
		keyword: SqlLexer.EXCLUSIVE,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
