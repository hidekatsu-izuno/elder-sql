...
export default [
    ...
    new Token(SqlLexer.Identifier, "TRANSACTION", { keyword: SqlLexer.TRANSACTION, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(12, 2, 6)})], location: new SourceLocation(13, 2, 7)}),
    ...
    new Token(SqlLexer.Identifier, "TRANSACTION", { keyword: SqlLexer.TRANSACTION, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(90, 6, 15)})], location: new SourceLocation(91, 6, 16)}),
    ...
    new Token(SqlLexer.Identifier, "TRANSACTION", { keyword: SqlLexer.TRANSACTION, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(119, 7, 16)})], location: new SourceLocation(120, 7, 17)}),
    ...
    new Token(SqlLexer.Identifier, "TRANSACTION", { keyword: SqlLexer.TRANSACTION, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(148, 8, 16)})], postskips: [new Token(SqlLexer.LineBreak, "\n", { location: new SourceLocation(160, 8, 28)})], location: new SourceLocation(149, 8, 17)}),
