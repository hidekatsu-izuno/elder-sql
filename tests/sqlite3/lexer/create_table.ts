...
export default [
	new Token(SqlLexer.Reserved, "CREATE", {
		...
		preskips: [
			new Token(SqlLexer.BlockComment, "/* test table_1 */", {
	...
	new Token(SqlLexer.Dot, ".", { location: new SourceLocation(36, 2, 18) }),
	new Token(SqlLexer.Identifier, "table_1", {
		postskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "text_column", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, "  ", {
	...
	new Token(SqlLexer.Comma, ",", {
		postskips: [
			...
			new Token(SqlLexer.LineComment, "-- text affinity", {
	...
	new Token(SqlLexer.Identifier, "num_column", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, "  ", {
	...
	new Token(SqlLexer.Comma, ",", {
		postskips: [
			...
			new Token(SqlLexer.LineComment, "-- numeric affinity", {
	...
	new Token(SqlLexer.Identifier, "int_column", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, "  ", {
	...
	new Token(SqlLexer.Comma, ",", {
		postskips: [
			...
			new Token(SqlLexer.LineComment, "-- integer affinity", {
	...
	new Token(SqlLexer.Identifier, "real_column", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, "  ", {
	...
	new Token(SqlLexer.Comma, ",", {
		postskips: [
			...
			new Token(SqlLexer.LineComment, "-- real affinity", {
	...
	new Token(SqlLexer.Identifier, "blob_column", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, "  ", {
	...
	new Token(SqlLexer.Identifier, "BLOB", {
		keyword: SqlLexer.BLOB,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Comma, ",", {
		postskips: [
			...
			new Token(SqlLexer.LineComment, "-- no affinity", {
	...
	new Token(SqlLexer.Identifier, "no_affinity_column", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, "  ", {
	...
	new Token(SqlLexer.Reserved, "CREATE", {
		...
		preskips: [
			...
			new Token(SqlLexer.BlockComment, "/* test table_2 */", {
	...
	new Token(SqlLexer.Identifier, "temp", {
		keyword: SqlLexer.TEMP,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "table_2", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Comma, ",", {
		postskips: [
			...
			new Token(SqlLexer.BlockComment, "/*text affinity*/", {
	...
	new Token(SqlLexer.Comma, ",", {
		postskips: [
			...
			new Token(SqlLexer.BlockComment, "/*numeric affinity*/", {
	...
	new Token(SqlLexer.Comma, ",", {
		postskips: [
			...
			new Token(SqlLexer.BlockComment, "/*integer affinity*/", {
	...
	new Token(SqlLexer.Comma, ",", {
		postskips: [
			...
			new Token(SqlLexer.BlockComment, "/*real affinity*/", {
	...
	new Token(SqlLexer.Comma, ",", {
		postskips: [
			...
			new Token(SqlLexer.BlockComment, "/*no affinity*/", {
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(652, 19, 27) }),
	new Token(SqlLexer.Identifier, "num_column", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Reserved, "CREATE", {
		keyword: SqlLexer.CREATE,
		preskips: [
			new Token(SqlLexer.BlockComment, "/* test table_3 */", {
	...
	new Token(SqlLexer.Reserved, "temporary", {
		keyword: SqlLexer.TEMPORARY,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "table_3", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "col_1", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, "  ", {
	...
	new Token(SqlLexer.Identifier, "col_2", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, "  ", {
	...
	new Token(SqlLexer.Identifier, "c_001", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(786, 26, 34) }),
	new Token(SqlLexer.Identifier, "col_2", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "CONFLICT", {
		keyword: SqlLexer.CONFLICT,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "ROLLBACK", {
		keyword: SqlLexer.ROLLBACK,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "c_002", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "c_003", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Reserved, "FOREIGN", {
		keyword: SqlLexer.FOREIGN,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(908, 29, 39) }),
	new Token(SqlLexer.Identifier, "col_2", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Reserved, "REFERENCES", {
		keyword: SqlLexer.REFERENCES,
		preskips: [
			new Token(SqlLexer.WhiteSpace, "    ", {
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(953, 30, 36) }),
	new Token(SqlLexer.Identifier, "num_column", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "MATCH", {
		keyword: SqlLexer.MATCH,
		preskips: [
			new Token(SqlLexer.WhiteSpace, "    ", {
	...
	new Token(SqlLexer.Identifier, "SIMPLE", {
		keyword: SqlLexer.SIMPLE,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "CASCADE", {
		keyword: SqlLexer.CASCADE,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Reserved, "DEFERRABLE", {
		keyword: SqlLexer.DEFERRABLE,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "INITIALLY", {
		keyword: SqlLexer.INITIALLY,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "DEFERRED", {
		keyword: SqlLexer.DEFERRED,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "VIRTUAL", {
		keyword: SqlLexer.VIRTUAL,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "tablename", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "modulename", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Dot, ".", { location: new SourceLocation(1145, 38, 26) }),
	new Token(SqlLexer.Identifier, "t1", {
	...
	new Token(SqlLexer.Identifier, "csv", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "filename", {
		postskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.String, "'thefile.csv'", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "fts5", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "sender", {
	...
	new Token(SqlLexer.EoS, ""),
	new Token(SqlLexer.EoF, "", { location: new SourceLocation(1245, 39, 60) }),
];
