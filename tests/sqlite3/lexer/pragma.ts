...
export default [
	new Token(SqlLexer.Identifier, "PRAGMA", {
		keyword: SqlLexer.PRAGMA,
		location: new SourceLocation(0, 1, 0),
	}),
	new Token(SqlLexer.Identifier, "analysis_limit", {
		preskips: [
	...
	new Token(SqlLexer.Dot, ".", { location: new SourceLocation(61, 3, 12) }),
	new Token(SqlLexer.Identifier, "application_id", {
	...
	new Token(SqlLexer.Dot, ".", { location: new SourceLocation(89, 4, 12) }),
	new Token(SqlLexer.Identifier, "application_id", {
		postskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Dot, ".", { location: new SourceLocation(123, 5, 12) }),
	new Token(SqlLexer.Identifier, "auto_vacuum", {
	...
	new Token(SqlLexer.Dot, ".", { location: new SourceLocation(148, 6, 12) }),
	new Token(SqlLexer.Identifier, "auto_vacuum", {
		postskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "NONE", {
		keyword: SqlLexer.NONE,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "automatic_index", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Dot, ".", { location: new SourceLocation(235, 9, 12) }),
	new Token(SqlLexer.Identifier, "index_info", {
		location: new SourceLocation(236, 9, 13),
	}),
	new Token(SqlLexer.LeftParen, "(", {
		location: new SourceLocation(246, 9, 23),
	}),
	new Token(SqlLexer.String, "'test.pk_test'", {
	...
	new Token(SqlLexer.EoF, "", { location: new SourceLocation(264, 10, 1) }),
];
