...
export default [
    ...
    new Token(SqlLexer.Reserved, "INTO", { keyword: SqlLexer.INTO, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(32, 3, 12)})], location: new SourceLocation(33, 3, 13)}),
    ...
    new Token(SqlLexer.Reserved, "INTO", { keyword: SqlLexer.INTO, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(60, 4, 7)})], location: new SourceLocation(61, 4, 8)}),
