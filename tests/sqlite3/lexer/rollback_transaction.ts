...
export default [
    ...
    new Token(SqlLexer.Reserved, "TRANSACTION", { keyword: SqlLexer.TRANSACTION, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(18, 2, 9)})], location: new SourceLocation(19, 2, 10)}),
    ...
    new Token(SqlLexer.Reserved, "TRANSACTION", { keyword: SqlLexer.TRANSACTION, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(40, 3, 9)})], location: new SourceLocation(41, 3, 10)}),
    new Token(SqlLexer.Reserved, "TO", { keyword: SqlLexer.TO, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(52, 3, 21)})], location: new SourceLocation(53, 3, 22)}),
    ...
    new Token(SqlLexer.Reserved, "TRANSACTION", { keyword: SqlLexer.TRANSACTION, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(71, 4, 9)})], location: new SourceLocation(72, 4, 10)}),
    new Token(SqlLexer.Reserved, "TO", { keyword: SqlLexer.TO, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(83, 4, 21)})], location: new SourceLocation(84, 4, 22)}),
