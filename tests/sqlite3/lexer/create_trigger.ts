...
export default [
	...
	new Token(SqlLexer.Identifier, "TRIGGER", {
		keyword: SqlLexer.TRIGGER,
		preskips: [
	...
	new Token(SqlLexer.Identifier, "update_customer_address", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "address", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "customers", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "FOR", {
		keyword: SqlLexer.FOR,
		location: new SourceLocation(70, 2, 1),
	}),
	new Token(SqlLexer.Identifier, "EACH", {
		keyword: SqlLexer.EACH,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "ROW", {
		keyword: SqlLexer.ROW,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "BEGIN", {
	...
	new Token(SqlLexer.Identifier, "new", {
		keyword: SqlLexer.NEW,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "customer_name", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "old", {
		keyword: SqlLexer.OLD,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "ex1", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "AFTER", {
		keyword: SqlLexer.AFTER,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "tab1", {
	...
	new Token(SqlLexer.Identifier, "cust_addr_chng", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "INSTEAD", {
		keyword: SqlLexer.INSTEAD,
	...
	new Token(SqlLexer.Identifier, "cust_addr", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "customer_address", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "customer", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "ex2", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "BEFORE", {
		keyword: SqlLexer.BEFORE,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
