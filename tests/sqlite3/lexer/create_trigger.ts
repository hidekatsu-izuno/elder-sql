...
export default [
    ...
    new Token(SqlLexer.Reserved, "UPDATE", { keyword: SqlLexer.UPDATE, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(38, 1, 38)})], location: new SourceLocation(39, 1, 39)}),
    ...
    new Token(SqlLexer.Reserved, "ON", { keyword: SqlLexer.ON, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(56, 1, 56)})], location: new SourceLocation(57, 1, 57)}),
    ...
    new Token(SqlLexer.Reserved, "UPDATE", { keyword: SqlLexer.UPDATE, preskips: [new Token(SqlLexer.WhiteSpace, "  ", { location: new SourceLocation(89, 4, 1)})], location: new SourceLocation(91, 4, 3)}),
    ...
    new Token(SqlLexer.Reserved, "SET", { keyword: SqlLexer.SET, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(104, 4, 16)})], location: new SourceLocation(105, 4, 17)}),
    ...
    new Token(SqlLexer.Reserved, "WHERE", { keyword: SqlLexer.WHERE, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(130, 4, 42)})], location: new SourceLocation(131, 4, 43)}),
    ...
    new Token(SqlLexer.Reserved, "CREATE", { keyword: SqlLexer.CREATE, location: new SourceLocation(168, 6, 1)}),
    ...
    new Token(SqlLexer.Reserved, "INSERT", { keyword: SqlLexer.INSERT, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(197, 6, 30)})], location: new SourceLocation(198, 6, 31)}),
    new Token(SqlLexer.Reserved, "ON", { keyword: SqlLexer.ON, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(204, 6, 37)})], location: new SourceLocation(205, 6, 38)}),
    ...
    new Token(SqlLexer.Reserved, "INSERT", { keyword: SqlLexer.INSERT, preskips: [new Token(SqlLexer.WhiteSpace, "  ", { location: new SourceLocation(225, 7, 1)})], location: new SourceLocation(227, 7, 3)}),
    new Token(SqlLexer.Reserved, "INTO", { keyword: SqlLexer.INTO, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(233, 7, 9)})], location: new SourceLocation(234, 7, 10)}),
    ...
    new Token(SqlLexer.Reserved, "VALUES", { keyword: SqlLexer.VALUES, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(249, 7, 25)})], postskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(256, 7, 32)})], location: new SourceLocation(250, 7, 26)}),
    ...
    new Token(SqlLexer.Reserved, "CREATE", { keyword: SqlLexer.CREATE, location: new SourceLocation(271, 9, 1)}),
    ...
    new Token(SqlLexer.Reserved, "UPDATE", { keyword: SqlLexer.UPDATE, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(311, 10, 11)})], location: new SourceLocation(312, 10, 12)}),
    ...
    new Token(SqlLexer.Reserved, "ON", { keyword: SqlLexer.ON, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(331, 10, 31)})], location: new SourceLocation(332, 10, 32)}),
    ...
    new Token(SqlLexer.Reserved, "UPDATE", { keyword: SqlLexer.UPDATE, preskips: [new Token(SqlLexer.WhiteSpace, "  ", { location: new SourceLocation(358, 12, 1)})], location: new SourceLocation(360, 12, 3)}),
    ...
    new Token(SqlLexer.Reserved, "SET", { keyword: SqlLexer.SET, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(375, 12, 18)})], location: new SourceLocation(376, 12, 19)}),
    ...
    new Token(SqlLexer.Reserved, "WHERE", { keyword: SqlLexer.WHERE, preskips: [new Token(SqlLexer.WhiteSpace, "   ", { location: new SourceLocation(404, 13, 1)})], location: new SourceLocation(407, 13, 4)}),
    ...
    new Token(SqlLexer.Reserved, "CREATE", { keyword: SqlLexer.CREATE, location: new SourceLocation(439, 15, 1)}),
    ...
    new Token(SqlLexer.Reserved, "INSERT", { keyword: SqlLexer.INSERT, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(469, 15, 31)})], location: new SourceLocation(470, 15, 32)}),
    new Token(SqlLexer.Reserved, "ON", { keyword: SqlLexer.ON, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(476, 15, 38)})], location: new SourceLocation(477, 15, 39)}),
    ...
    new Token(SqlLexer.Reserved, "DELETE", { keyword: SqlLexer.DELETE, preskips: [new Token(SqlLexer.WhiteSpace, "  ", { location: new SourceLocation(497, 16, 1)})], location: new SourceLocation(499, 16, 3)}),
    new Token(SqlLexer.Reserved, "FROM", { keyword: SqlLexer.FROM, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(505, 16, 9)})], location: new SourceLocation(506, 16, 10)}),
    ...
    new Token(SqlLexer.Reserved, "WHERE", { keyword: SqlLexer.WHERE, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(517, 16, 21)})], location: new SourceLocation(518, 16, 22)}),
