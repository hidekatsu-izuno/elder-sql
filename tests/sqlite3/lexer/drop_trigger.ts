...
export default [
    ...
    new Token(SqlLexer.Identifier, "EXISTS", { keyword: SqlLexer.EXISTS, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(66, 3, 16)})], location: new SourceLocation(67, 3, 17)}),
