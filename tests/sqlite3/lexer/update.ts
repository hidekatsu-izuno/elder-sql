...
export default [
	...
	new Token(SqlLexer.Dot, ".", { location: new SourceLocation(36, 2, 12) }),
	new Token(SqlLexer.Identifier, "sample", {
		keyword: SqlLexer.SAMPLE,
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(53, 2, 29) }),
	...
	new Token(SqlLexer.Identifier, "dest", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(131, 4, 32) }),
	new Token(SqlLexer.Identifier, "b", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Dot, ".", { location: new SourceLocation(156, 4, 57) }),
	new Token(SqlLexer.Identifier, "c", {
		postskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Dot, ".", { location: new SourceLocation(162, 4, 63) }),
	new Token(SqlLexer.Identifier, "c", {
	...
	new Token(SqlLexer.Dot, ".", { location: new SourceLocation(177, 5, 12) }),
	new Token(SqlLexer.Identifier, "sample", {
		keyword: SqlLexer.SAMPLE,
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(194, 5, 29) }),
	new Token(SqlLexer.Identifier, "b", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(222, 5, 57) }),
	new Token(SqlLexer.Numeric, "1", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.EoF, "", { location: new SourceLocation(235, 6, 1) }),
];
