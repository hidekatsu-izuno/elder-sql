...
export default [
	new Token(SqlLexer.Identifier, "EXPLAIN", {
		keyword: SqlLexer.EXPLAIN,
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(16, 1, 16) }),
	...
	new Token(SqlLexer.Numeric, "1", { location: new SourceLocation(36, 1, 36) }),
	...
	new Token(SqlLexer.Identifier, "QUERY", {
		keyword: SqlLexer.QUERY,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "PLAN", {
		keyword: SqlLexer.PLAN,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Dot, ".", { location: new SourceLocation(68, 3, 29) }),
	new Token(SqlLexer.Operator, "*", {
		location: new SourceLocation(69, 3, 30),
	}),
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(70, 3, 31) }),
	new Token(SqlLexer.Identifier, "t2", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Dot, ".", { location: new SourceLocation(74, 3, 35) }),
	new Token(SqlLexer.Operator, "*", {
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(84, 3, 45) }),
	new Token(SqlLexer.Identifier, "t2", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Dot, ".", { location: new SourceLocation(97, 3, 58) }),
	new Token(SqlLexer.Identifier, "a", {
	...
	new Token(SqlLexer.Dot, ".", { location: new SourceLocation(108, 3, 69) }),
	new Token(SqlLexer.Identifier, "b", {
	...
	new Token(SqlLexer.EoS, ""),
	new Token(SqlLexer.EoF, "", { location: new SourceLocation(113, 3, 74) }),
];
