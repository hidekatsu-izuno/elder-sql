...
export default [
    new Token(SqlLexer.Identifier, "COMMIT", { keyword: SqlLexer.COMMIT, location: new SourceLocation(0, 1, 0)}),
    ...
    new Token(SqlLexer.Identifier, "COMMIT", { keyword: SqlLexer.COMMIT, location: new SourceLocation(8, 2, 1)}),
    new Token(SqlLexer.Identifier, "TRANSACTION", { keyword: SqlLexer.TRANSACTION, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(14, 2, 7)})], location: new SourceLocation(15, 2, 8)}),
    ...
    new Token(SqlLexer.Identifier, "TRANSACTION", { keyword: SqlLexer.TRANSACTION, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(36, 4, 4)})], postskips: [new Token(SqlLexer.LineBreak, "\n", { location: new SourceLocation(48, 4, 16)})], location: new SourceLocation(37, 4, 5)}),
