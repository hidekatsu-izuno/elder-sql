...
export default [
    new Token(SqlLexer.Identifier, "SELECT", { keyword: SqlLexer.SELECT, postskips: [new Token(SqlLexer.LineBreak, "\n", { location: new SourceLocation(6, 1, 6)})], location: new SourceLocation(0, 1, 0)}),
    new Token(SqlLexer.Identifier, "UPDATE", { keyword: SqlLexer.UPDATE, postskips: [new Token(SqlLexer.LineBreak, "\n", { location: new SourceLocation(13, 2, 7)})], location: new SourceLocation(7, 2, 1)}),
    new Token(SqlLexer.Identifier, "select", { keyword: SqlLexer.SELECT, location: new SourceLocation(14, 3, 1)}),
    ...
    new Token(SqlLexer.Identifier, "CREATE", { keyword: SqlLexer.CREATE, location: new SourceLocation(27, 4, 1)}),
    new Token(SqlLexer.Identifier, "TABLE", { keyword: SqlLexer.TABLE, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(33, 4, 7)})], location: new SourceLocation(34, 4, 8)}),
    ...
    new Token(SqlLexer.Identifier, "CREATE", { keyword: SqlLexer.CREATE, preskips: [new Token(SqlLexer.LineBreak, "\n", { location: new SourceLocation(41, 5, 1)})], location: new SourceLocation(42, 6, 1)}),
    ...
    new Token(SqlLexer.Identifier, "FROM", { keyword: SqlLexer.FROM, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(54, 6, 13)})], postskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(59, 6, 18)})], location: new SourceLocation(55, 6, 14)}),
