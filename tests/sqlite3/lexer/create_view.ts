...
export default [
	...
	new Token(SqlLexer.Identifier, "VIEW", {
		keyword: SqlLexer.VIEW,
		preskips: [
	...
	new Token(SqlLexer.Identifier, "v_sample", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Dot, ".", { location: new SourceLocation(64, 2, 31) }),
	new Token(SqlLexer.Identifier, "v_sample", {
		postskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Dot, ".", { location: new SourceLocation(112, 3, 22) }),
	new Token(SqlLexer.Identifier, "v_sample", {
	...
	new Token(SqlLexer.Dot, ".", { location: new SourceLocation(161, 4, 27) }),
	new Token(SqlLexer.Identifier, "v_sample", {
		postskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(173, 4, 39) }),
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(176, 4, 42) }),
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(192, 4, 58) }),
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(195, 4, 61) }),
	...
	new Token(SqlLexer.Dot, ".", { location: new SourceLocation(240, 5, 41) }),
	new Token(SqlLexer.Identifier, "v_sample", {
	...
	new Token(SqlLexer.EoF, "", { location: new SourceLocation(263, 6, 1) }),
];
