...
export default [
	...
	new Token(SqlLexer.Identifier, "ix_sample", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Dot, ".", { location: new SourceLocation(55, 2, 18) }),
	new Token(SqlLexer.Identifier, "ix_sample", {
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(78, 2, 41) }),
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(81, 2, 44) }),
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(122, 3, 36) }),
	new Token(SqlLexer.Identifier, "b", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "ASC", {
		keyword: SqlLexer.ASC,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(129, 3, 43) }),
	new Token(SqlLexer.Identifier, "c", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "DESC", {
	...
	new Token(SqlLexer.Dot, ".", { location: new SourceLocation(171, 4, 32) }),
	new Token(SqlLexer.Identifier, "ix_sample", {
	...
	new Token(SqlLexer.Dot, ".", { location: new SourceLocation(237, 5, 25) }),
	new Token(SqlLexer.Identifier, "ix_sample", {
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(268, 5, 56) }),
	new Token(SqlLexer.Identifier, "b", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(280, 5, 68) }),
	new Token(SqlLexer.Identifier, "c", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Dot, ".", { location: new SourceLocation(324, 6, 39) }),
	new Token(SqlLexer.Identifier, "ix_sample", {
	...
	new Token(SqlLexer.Reserved, "COLLATE", {
		keyword: SqlLexer.COLLATE,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Dot, ".", { location: new SourceLocation(413, 7, 39) }),
	new Token(SqlLexer.Identifier, "ix_sample", {
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(453, 7, 79) }),
	new Token(SqlLexer.Identifier, "b", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.EoF, "", { location: new SourceLocation(490, 7, 116) }),
];
