...
export default [
	new Token(SqlLexer.Identifier, "ATTACH", {
		keyword: SqlLexer.ATTACH,
	...
	new Token(SqlLexer.String, "':memory:'", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.String, "'new_database.db'", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "CONCAT", {
		keyword: SqlLexer.CONCAT,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.String, "'new_database'", {
		location: new SourceLocation(106, 3, 24),
	}),
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(120, 3, 38) }),
	new Token(SqlLexer.String, "'.db'", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.String, "'database_'", {
		postskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "strftime", {
		keyword: SqlLexer.STRFTIME,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.String, "'%Y%m%d'", {
		location: new SourceLocation(181, 4, 42),
	}),
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(189, 4, 50) }),
	new Token(SqlLexer.String, "'now'", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.EoF, "", { location: new SourceLocation(294, 7, 1) }),
];
