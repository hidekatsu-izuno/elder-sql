...
export default [
    new Token(SqlLexer.Identifier, "DELETE", { keyword: SqlLexer.DELETE, location: new SourceLocation(0, 1, 0)}),
    new Token(SqlLexer.Identifier, "FROM", { keyword: SqlLexer.FROM, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(6, 1, 6)})], location: new SourceLocation(7, 1, 7)}),
    ...
    new Token(SqlLexer.Identifier, "DELETE", { keyword: SqlLexer.DELETE, location: new SourceLocation(20, 2, 1)}),
    new Token(SqlLexer.Identifier, "FROM", { keyword: SqlLexer.FROM, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(26, 2, 7)})], location: new SourceLocation(27, 2, 8)}),
    ...
    new Token(SqlLexer.Identifier, "AS", { keyword: SqlLexer.AS, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(51, 3, 7)})], postskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(54, 3, 10)})], location: new SourceLocation(52, 3, 8)}),
    new Token(SqlLexer.LeftParen, "(", { location: new SourceLocation(55, 3, 11)}),
    new Token(SqlLexer.Identifier, "SELECT", { keyword: SqlLexer.SELECT, location: new SourceLocation(56, 3, 12)}),
    ...
    new Token(SqlLexer.Identifier, "AS", { keyword: SqlLexer.AS, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(64, 3, 20)})], location: new SourceLocation(65, 3, 21)}),
    ...
    new Token(SqlLexer.Identifier, "DELETE", { keyword: SqlLexer.DELETE, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(70, 3, 26)})], location: new SourceLocation(71, 3, 27)}),
    new Token(SqlLexer.Identifier, "FROM", { keyword: SqlLexer.FROM, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(77, 3, 33)})], location: new SourceLocation(78, 3, 34)}),
    ...
    new Token(SqlLexer.Identifier, "WHERE", { keyword: SqlLexer.WHERE, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(94, 3, 50)})], location: new SourceLocation(95, 3, 51)}),
    ...
    new Token(SqlLexer.Identifier, "SELECT", { keyword: SqlLexer.SELECT, location: new SourceLocation(106, 3, 62)}),
    ...
    new Token(SqlLexer.Identifier, "FROM", { keyword: SqlLexer.FROM, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(114, 3, 70)})], location: new SourceLocation(115, 3, 71)}),
    ...
    new Token(SqlLexer.Identifier, "DELETE", { keyword: SqlLexer.DELETE, location: new SourceLocation(124, 4, 1)}),
    new Token(SqlLexer.Identifier, "FROM", { keyword: SqlLexer.FROM, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(130, 4, 7)})], location: new SourceLocation(131, 4, 8)}),
    ...
    new Token(SqlLexer.Identifier, "WHERE", { keyword: SqlLexer.WHERE, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(147, 4, 24)})], location: new SourceLocation(148, 4, 25)}),
    ...
    new Token(SqlLexer.Identifier, "AND", { keyword: SqlLexer.AND, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(159, 4, 36)})], location: new SourceLocation(160, 4, 37)}),
    ...
    new Token(SqlLexer.Identifier, "RETURNING", { keyword: SqlLexer.RETURNING, preskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(169, 4, 46)})], postskips: [new Token(SqlLexer.WhiteSpace, " ", { location: new SourceLocation(179, 4, 56)})], location: new SourceLocation(170, 4, 47)}),
