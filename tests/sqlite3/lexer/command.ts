...
export default [
	new Token(SqlLexer.Command, ".print", {
		preskips: [
			new Token(SqlLexer.BlockComment, "/*test\n.print test\n*/", {
	...
	new Token(SqlLexer.Identifier, "print", {
		keyword: SqlLexer.PRINT,
	...
	new Token(SqlLexer.Reserved, "select", {
		keyword: SqlLexer.SELECT,
		preskips: [
			new Token(SqlLexer.BlockComment, "/*.print*/", {
	...
	new Token(SqlLexer.Delimiter, "GO", {
		preskips: [
			new Token(SqlLexer.LineComment, "-- aaa", {
				location: new SourceLocation(120, 14, 1),
			}),
			new Token(SqlLexer.LineBreak, "\n", {
				location: new SourceLocation(126, 14, 7),
			}),
			new Token(SqlLexer.LineComment, "-- bbb", {
