...
export default [
    ...
    new Token(SqlLexer.Reserved, "select", { keyword: SqlLexer.SELECT, location: new SourceLocation(34, 5, 1)}),
    ...
    new Token(SqlLexer.Reserved, "select", { keyword: SqlLexer.SELECT, location: new SourceLocation(44, 6, 1)}),
    ...
    new Token(SqlLexer.Reserved, "select", { keyword: SqlLexer.SELECT, preskips: [new Token(SqlLexer.BlockComment, "/*.print*/", { location: new SourceLocation(71, 9, 1)}), new Token(SqlLexer.WhiteSpace, "   ", { location: new SourceLocation(81, 9, 11)}), new Token(SqlLexer.LineBreak, "\n", { location: new SourceLocation(84, 9, 14)})], location: new SourceLocation(85, 10, 1)}),
    ...
    new Token(SqlLexer.Reserved, "select", { keyword: SqlLexer.SELECT, location: new SourceLocation(99, 13, 1)}),
