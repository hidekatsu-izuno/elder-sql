...
export default [
	...
	new Token(SqlLexer.Operator, "+", {
		preskips: [
			...
			new Token(SqlLexer.BlockComment, "/*!80000 - 1 */", {
	...
	new Token(SqlLexer.Reserved, "AS", {
		...
		preskips: [
			...
			new Token(SqlLexer.BlockComment, "/*!32302 - 2*/", {
			...
			new Token(SqlLexer.BlockComment, "/*!80000-3 */", {
			...
			new Token(SqlLexer.BlockComment, "/*!- 4 */", {
			...
			new Token(SqlLexer.BlockComment, "/*! -5*/", {
