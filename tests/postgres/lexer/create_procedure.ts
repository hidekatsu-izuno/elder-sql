...
export default [
	...
	new Token(SqlLexer.Identifier, "PROCEDURE", {
	...
	new Token(SqlLexer.Identifier, "insert_data", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "ATOMIC", {
		keyword: SqlLexer.ATOMIC,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "INSERT", {
	...
	new Token(SqlLexer.Identifier, "tbl", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
