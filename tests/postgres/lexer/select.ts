...
export default [
	...
	new Token(SqlLexer.Identifier, "sum", {
		keyword: SqlLexer.SUM,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "total", {
		keyword: SqlLexer.TOTAL,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Reserved, "HAVING", {
		keyword: SqlLexer.HAVING,
		preskips: [
			new Token(SqlLexer.WhiteSpace, "    ", {
	...
	new Token(SqlLexer.String, "'5 hours'", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Reserved, "UNION", {
		keyword: SqlLexer.UNION,
		postskips: [
			new Token(SqlLexer.LineBreak, "\n", {
	...
	new Token(SqlLexer.Identifier, "actors", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Numeric, "111", {
	...
	new Token(SqlLexer.Identifier, "unnest", {
		keyword: SqlLexer.UNNEST,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Reserved, "ARRAY", {
		keyword: SqlLexer.ARRAY,
	...
	new Token(SqlLexer.Identifier, "ORDINALITY", {
		keyword: SqlLexer.ORDINALITY,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "t", {
		keyword: SqlLexer.T,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "random", {
		keyword: SqlLexer.RANDOM,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "generate_series", {
		keyword: SqlLexer.GENERATE_SERIES,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Reserved, "ALL", {
		keyword: SqlLexer.ALL,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "RECURSIVE", {
		keyword: SqlLexer.RECURSIVE,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "employee_recursive", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "manager_name", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "employee", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.String, "'Mary'", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "er", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "m", {
		keyword: SqlLexer.M,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "mname", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "pname", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "manufacturers", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Reserved, "LATERAL", {
		keyword: SqlLexer.LATERAL,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "get_product_names", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "JOIN", {
	...
	new Token(SqlLexer.Reserved, "true", {
