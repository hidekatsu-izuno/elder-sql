...
export default [
	...
	new Token(SqlLexer.Identifier, "FUNCTION", {
	...
	new Token(SqlLexer.Identifier, "add", {
		keyword: SqlLexer.ADD,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(27, 1, 27) }),
	new Token(SqlLexer.Identifier, "integer", {
		keyword: SqlLexer.INTEGER,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "RETURNS", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.String, "'select $1 + $2;'", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "LANGUAGE", {
		keyword: SqlLexer.LANGUAGE,
		preskips: [
			new Token(SqlLexer.WhiteSpace, "    ", {
	...
	new Token(SqlLexer.Identifier, "SQL", {
		keyword: SqlLexer.SQL,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "IMMUTABLE", {
		keyword: SqlLexer.IMMUTABLE,
		preskips: [
			new Token(SqlLexer.WhiteSpace, "    ", {
	...
	new Token(SqlLexer.Identifier, "INPUT", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(172, 7, 30) }),
	...
	new Token(SqlLexer.Identifier, "increment", {
		keyword: SqlLexer.INCREMENT,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "plpgsql", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "dup", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(457, 19, 27) }),
	new Token(SqlLexer.Identifier, "out", {
		keyword: SqlLexer.OUT,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(469, 19, 39) }),
	new Token(SqlLexer.Identifier, "out", {
		keyword: SqlLexer.OUT,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(603, 23, 46) }),
	new Token(SqlLexer.Identifier, "f2", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "check_password", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "uname", {
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(729, 27, 42) }),
	new Token(SqlLexer.Identifier, "pass", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "SECURITY", {
		keyword: SqlLexer.SECURITY,
		preskips: [
			new Token(SqlLexer.WhiteSpace, "    ", {
	...
	new Token(SqlLexer.Identifier, "DEFINER", {
		keyword: SqlLexer.DEFINER,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "SET", {
	...
	new Token(SqlLexer.Identifier, "search_path", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Identifier, "admin", {
		keyword: SqlLexer.ADMIN,
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
	...
	new Token(SqlLexer.Comma, ",", { location: new SourceLocation(984, 40, 28) }),
	new Token(SqlLexer.Identifier, "pg_temp", {
		preskips: [
			new Token(SqlLexer.WhiteSpace, " ", {
